...
load Data_New_NLC_5000_SNR_20_L8_change600

InputDimen = 8;
NumExperim = 50;

filename = ['Fig_change_600'  '_3'];


rho_NORMA = 0;  PAKerSize_NORMA = 4;  Coeffeta = 0.001;

rho_RPA = 0; PAKerSize_RPA = 4; Budget_RPA = 200;

rho_F = 0;  PAKerSize_F = 4;  Budget_F = 200;

q_S_1 = 16; delta_S_1 = 5;  L_S_1 = 800;  SK_APSM = 4; 
...
print(gcf, 'my_plot600.png', '-dpng', '-r300'); % '-r300' 设置分辨率为300 dpi
toc
