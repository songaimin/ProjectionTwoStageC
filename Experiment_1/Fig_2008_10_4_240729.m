...
filename = ['Fig_220706_2008_L4'  '_4'];


rho_NORMA = 0;  PAKerSize_NORMA = 2;  Coeffeta = 0.001;

rho_RPA = 0; PAKerSize_RPA = 0.707; Budget_RPA = 200;

rho_F = 0;  PAKerSize_F = 0.707;  Budget_F = 200;

q_S_1 = 16; delta_S_1 = 5;  L_S_1 = 500;  SK_APSM = 0.707;
...
for NNN = 1:NumExperim
    ...
    PA_4 = Projectron();
    PA_4.kernelsize = 0.707;
    PA_4.eta_error = 0.001;
    
    PA_5 = Projectron_Plus();
    PA_5.kernelsize = 0.707;
    PA_5.eta_error = 0.001;
    
    PA_6 = OLRU();
    PA_6.kernelsize = 0.707;

    PA_7 = OLRD();
    PA_7.kernelsize = 0.707;
    
    PA_8 = SPA();
    PA_8.kernelsize = 0.707;
...
plot(Index,BERateAPSM_1_Kav,'-.',Index,BERateAPSM_8_Kav,'-o',Index,BERateAPSM_9_Kav,':+',...
    Index,BERateAPSM_6_Kav,'-*',Index,BERateAPSM_7_Kav,'-v',Index,BERateAPSM_3_Kav,':s',...
    Index,BERateAPSM_5_Kav,'-h',Index,BERateAPSM_10_Kav,'-d',...
...
% print(gcf, 'my_plot2.png', '-dpng', '-r1200'); % '-r300' 设置分辨率为300 dpi
